...
docker compose --env-file tests/sim_full_path_gate/empty.env -p kairos-sim-full-path-gate-20260919-r1 -f docker-compose.sim-full-path.yml config --format json > compose-sim-full-path.json
