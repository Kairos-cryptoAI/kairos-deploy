...
The `20260923-r1` project identity is a new source snapshot; artifacts from the
...
docker compose -p kairos-current-release-gate-20260923-r1 -f docker-compose.current-release-gate.yml config --quiet
```
...
```powershell
docker compose -p kairos-current-release-gate-20260923-r1 -f docker-compose.current-release-gate.yml build gate
docker compose -p kairos-current-release-gate-20260923-r1 -f docker-compose.current-release-gate.yml up --no-deps gate
```
